...
//       await iEnterAValidEmail(tester);
//       await iEnterAValidPhoneNumber(tester);
//       await iEnterAValidPassword(tester);
//       await iConfirmThePassword(tester);
...
//       await iAmOnTheRegistrationScreen(tester);
//       await iEnterAnInvalidEmail(tester);
//       await iEnterAValidPhoneNumber(tester);
//       await iEnterAValidPassword(tester);
//       await iConfirmThePassword(tester);
//       await iTapTheSignUpButton(tester);
...
//       await iAmOnTheRegistrationScreen(tester);
//       await iEnterAValidEmail(tester);
//       await iEnterAnInvalidPhoneNumber(tester);
//       await iEnterAValidPassword(tester);
//       await iConfirmThePassword(tester);
//       await iTapTheSignUpButton(tester);
...
//       await iEnterAValidEmail(tester);
//       await iEnterAValidPhoneNumber(tester);
//       await iEnterAnInvalidPassword(tester);
//       await iConfirmThePassword(tester);
//       await iTapTheSignUpButton(tester);
...
//       await iEnterAValidPhoneNumber(tester);
//       await iEnterAValidPassword(tester);
//       await iEnterADifferentPasswordForConfirmation(tester);
//       await iTapTheSignUpButton(tester);
